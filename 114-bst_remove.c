 ...
 * @root: A pntr to the root node of the BST to search.
 *
 ...
 * @root: A pntr to the root node of the BST.
 * @node: A pntr to the node to delete from the BST.
 *
 * Return: A pntr to the new root node after deletion.
 */
bst_t *bst_delete(bst_t *root, bst_t *node)
{
 ...
 * @root: A pntr to the root node of the BST to remove a node from.
 * @node: A pntr to the current node in the BST.
 * @value: The value to remove from the BST.
 *
 * Return: A pntr to the root node after deletion.
 */
bst_t *bst_remove_recursive(bst_t *root, bst_t *node, int value)
{
	if (node != NULL)
